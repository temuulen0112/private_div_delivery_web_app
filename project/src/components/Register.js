...
const Register = () => {
  const handleSubmit = (e) => {
    ...
    console.log(e.target.formEmail.value)
    console.log(e.target.formPassword.value)
    console.log(e.target.formResetPassword.value)
  }
  ...
  return (
    <div className="App-header1">
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="my-3" controlId="formResetPassword">
        ...
        <Button className="default" value="БҮРТГҮҮЛЭХ" type={"submit"}/>
      </Form>
    </div>
  );
};
